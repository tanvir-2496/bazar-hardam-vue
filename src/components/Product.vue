...
export default {
  ...
  methods: {
    ...
    addRow: function () {
      this.$router.push({ name: 'add-product', params: { action: "ADD"}, vendor: null }); 
      //console.log(JSON.stringify(model));
      //console.log(idx);
    },
    editRow: function (idx, model) {
      this.$router.push({ name: 'add-product', params: { action: "EDIT", vendor: JSON.stringify(model)} }); 
      //console.log(JSON.stringify(model));
      console.log(idx);
    },
