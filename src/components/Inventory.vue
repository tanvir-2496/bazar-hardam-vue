<template>
  ...
  <div class="table-responsive">
    <table id="vendor_table" class="table table-hover table-bordered align-middle col-12">
      <thead>
        <tr>
          <th scope="col">#</th>
          <th scope="col">Date</th>
          <th scope="col">Challan Ref</th>
...
export default {
  ...
  methods: {
    getAllInventory() {
      service.getAllInventoryGroupBy()
        .then(response => {
