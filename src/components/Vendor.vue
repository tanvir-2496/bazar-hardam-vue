<template>
  ...
  <div class="wrapper">
    ...
    <table id="vendorTable" class="table table-bordered mt-5">
      <thead>
        <tr>
          <th scope="col">#</th>
...
export default {
  ...
  methods: {
    ...
    addRow: function () {
      this.$router.push({ name: 'add-vendor', params: { action: "ADD"}, vendor: null }); 
      //console.log(JSON.stringify(model));
      //console.log(idx);
    },
    editRow: function (idx, model) {
      this.$router.push({ name: 'add-vendor', params: { action: "EDIT", vendor: JSON.stringify(model)} }); 
      //console.log(JSON.stringify(model));
      console.log(idx);
    },
